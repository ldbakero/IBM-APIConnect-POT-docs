...
1. Click the `Models` tab.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-model-design-page.png)
	
1. Click the `+ Add` button.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-model-design-page-add-button.png)
	
1. In the New LoopBack Model dialog, enter `item` as the model name, then click the `New` button.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-model-design-page-new-model.png)

1. When the Model edit page for the item model displays, select the `mysql-connection` Data Source:

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-model-datasource.png)
...
1. Scroll to the top of the page and click the `Save` button to save the data model.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-model-design-page-model-properties-save.png)
...
1. Click the `Run` button to open the Run page.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-run.png)
...
1. Wait a moment while the servers are started. Proceed to the next step when you see the following:
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-running.png)

1. Click the `Explore` button to review your APIs. 

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-explore.png)
...
1. Click the `GET /items` operation.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-explore-page-get-items-api.png)
...
1. Scroll down slowly to locate the `Call operation` button.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/api-designer-explore-page-call-operation.png)
...
1. Click the `Call operation` button to invoke the API.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/cert-error.png)
...
1. Return to the `Run` screen and click the `Stop` button to stop the application and MicroGateway.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/stop-application.png)
...
1. Click on the `inventory` link from the APIs tab.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/inventory-link.png)
...
1. Scroll down to the `Paths` section of the API definition.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/new-paths.png)
...
1. The script will execute a series `diff` commands against specific files in your project folder (`~/ThinkIBM/inventory`)
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab2/validate-lab-2.png)
