...
1. Click on the application favorites menu and open the `Atom` text editor.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/launch-atom.png)

1. From the `Atom` menu, click on `File > Open Folder`.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-open-folder.png)
...
1. Click on the `student` location from the Places menu, then navigate to the `ThinkIBM > inventory` folder and click the `OK` button.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-open-folder-inventory.png)
...
1. From the folder tree menu, expand the `server` folder and click on the `config.json` file to view the source.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-open-config.png)

1. Edit line 2 of the `config.json` file. Change `/api` to `/inventory`.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-edit-config.png)

1. Use the `Atom` file menu to save the changes.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-save-changes.png)
...
1. In the `Atom` editor, expand the directory structure for the `common/models` location and select the `item.js` file.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-item-file1.png)
...
1. To avoid potential for typing errors, a sample file is available for you to copy. Use the favorites menu to open the `Sublime Text` application.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/launch-sublime-text.png)
	
1. Expand the `lab_files/lab3` folder and select the example `item.js` file.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/sublime-item-file.png)
...
1. Return to the `Atom` application. **Remove** everything in the `item.js` file. Then paste (`control+v` or `Edit > Paste`) the contents of your clipboard to update the file.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/atom-item-file2.png)
...
1. Use the favorites menu to launch the `Firefox Web Browser`:
	  ...
	  ![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/launch-firefox.png)

1. Click on the `API Manager` bookmark:

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/api-mgr-bookmark.png)
...
1. Enter the following credentials and then click the the `Sign in` button:
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/api-mgr-login.png)
	
1. Now that the API Manager Dashboard is open, click the `+ Add` button and select `App` from the list:

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/api-mgr-add-app.png)
...
1. Fill out the `Add App` form with the following details:
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/api-mgr-app-info.png)
...
1. Click on the `hyperlink` icon inside of the `Inventory` app tile.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/app-config-link.png)

1. Copy the contents of the popup to your system clipboard.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/app-config-link-copy.png)

1. Return to the Firefox browser, click on the user profile icon and select `Log Out`.

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/api-mgr-signout.png)
...
1. The terminal will prompt you when the publication is complete:
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/app-published.png)
...
1. You will need the `host` header that is returned in the next lab.
	...
	**Highlight** the `host header:` value and then **right-mouse-click** to show the menu and select `Copy`.
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/app-copy-host.png)
	
1. Open the `Notes` application by clicking on the notepad icon in the task bar:

	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/launch-notepad.png)
...
1. Paste (use the `control+v` keyboard command) the host header into the `Notes` window. Add a label so that you know what the value is:
	...
	![](https://github.com/ibm-apic-pot/lab-guide/raw/master/img/lab3/notes-save-host.png)
